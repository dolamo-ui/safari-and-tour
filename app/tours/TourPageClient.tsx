...
const tours: Tour[] = [
  ...
  },
  {
    ...
    currency: "USD",
    tag: "Weekend",
    desc: "Resort access and the Valley of Waves at Sun City, a half-day safari at Pilanesberg Nature Reserve, and B&B accommodation at The Kingdom Resort. 3-night (from $752 pp) and 4-night (from $1,002 pp) options also available.",
